        ...
        <div class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container-fluid">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.php"><i class="fa fa-fw fa-gear"></i> Change Password</a>
            </div>
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <?php if ( $use_questions ) { ?>
                <li class="<?php if ( $action === "resetbyquestions" ) { echo "active"; } ?>">
                  ...
                  ><i class="fa fa-fw fa-question-circle"></i> Reset Using Security Questions</a>
                </li>
                <li class="<?php if ( $action === "setquestions" ) { echo "active"; } ?>">
                  <a href="?action=setquestions"
                     data-toggle="menu-popover"
                     data-content="<?php echo htmlentities(strip_tags($messages["changehelpquestions"])); ?>"
                  ><i class="fa fa-fw fa-question-circle"></i> Set Your Security Questions</a>
                </li>
                <?php } ?>
                <?php if ( $use_tokens ) { ?>
