...
$messages['changehelpquestions'] = "秘密の質問に回答してパスワードをリセットする";
$messages['changehelptoken'] = "メールでパスワードをリセットするためのリンクを送信する";
$messages['changehelpsms'] = "SMSでパスワードをリセットする";
...
$messages['changehelpsshkey'] = "SSHキーを変更する";
