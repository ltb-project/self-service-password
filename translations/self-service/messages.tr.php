...
$messages['changehelpquestions'] = "Soru yanıtlayarak parolanızı sıfırlayın";
$messages['changehelptoken'] = "Parola sıfırlama e-postası alın";
$messages['changehelpsms'] = "SMS ile parolanızı sıfırlayın";
...
$messages['changehelpsshkey'] = "SSH Anahtarınızı değiştirin";
