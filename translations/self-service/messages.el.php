...
$messages['changehelpquestions'] = "Αλλάξτε τον κωδικό σας απαντώντας σε ερωτήσεις";
$messages['changehelptoken'] = "Αποστολή email με σύνδεσμο αλλαγής κωδικού";
$messages['changehelpsms'] = "Αλλάξτε τον κωδικό σας μέσω SMS";
...
$messages['changehelpsshkey'] = "Αλλάξτε SSH Key σας";
