...
$messages['resetbyquestionshelp'] = "Choose a question and answer it to reset your password. This requires that you have already <a href=\"%set_question_path%\">register an answer</a>.";
$messages['changehelp'] = "Enter your old password and choose a new one.";
$messages['changehelpreset'] = "Forgot your password?";
$messages['changehelpquestions'] = "Reset your password by answering questions";
$messages['changehelptoken'] = "Email a password reset link";
$messages['changehelpsms'] = "Reset your password with a SMS";
$messages['changehelpsshkey'] = "Change your SSH Key";
