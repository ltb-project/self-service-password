...
class CheckSshkeyTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCheckSshkeyValidity()
    {
        ...
        $valid_key_ecdsa_sk = 'sk-ecdsa-sha2-nistp256@openssh.com AAAAInNrLWVjZHNhLXNoYTItbmlzdHAyNTZAb3BlbnNzaC5jb20AAAAIbmlzdHAyNTYAAABBBFyNc2ZaM0GXpq78MOLsRMhVyQnaMidoifn16WHOx/yD+KmF0oVHGuNp04RWAht527uSeqKLMMS79nC498PAb3UAAAAEc3NoOg== a@b';
        $valid_key_ed25519_sk = 'sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIPgAIaC5wL+ICBHYMWoAfMpXbzCkFYploZ/bVeFGa2TaAAAABHNzaDo= a@b';
        ...
        $this->assertEquals(true, check_sshkey($valid_key_ecdsa_sk, $ssh_valid_key_types));
        $this->assertEquals(true, check_sshkey($valid_key_ed25519_sk, $ssh_valid_key_types));
