...
require_once __DIR__ . '/../lib/captcha/FriendlyCaptcha2.php';

class FriendlyCaptcha2Test extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_construct(): void
    {
        ...
        $this->assertEquals('captcha\FriendlyCaptcha2', get_class($captchaInstance), "Wrong class");
    }
    ...
    public function test_generate_js_captcha(): void
    {
        ...
        $this->assertMatchesRegularExpression('/https:\/\/cdn.jsdelivr.net\/npm\/@friendlycaptcha/i',$js, "dummy js code returned");
    }
    ...
    public function test_verify_captcha_challenge_ok(): void
    {
        ...
        $_POST["frc-captcha-response"] = "ABCDE";
