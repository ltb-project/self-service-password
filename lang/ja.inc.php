...
$messages['tokensent_ifexists'] = "このアカウントが存在した場合、メールアドレスが関連したところに確認メールが届きます";
...
$messages['pwned'] = "あなたの新しいパスワードはすでに漏洩しています。それが使用されているその他すべてのサービズでパスワードを変更することを検討すべきです";
...
$messages['smsnomatch'] = "SMS番号は送信されたloginとマッチしません。";
