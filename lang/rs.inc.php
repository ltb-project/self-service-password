...
$messages['confirmpassword'] = "Potvrdi";
...
$messages['policy'] = "Vaša lozinka mora da ispunjava sledece uslove:";
...
$messages['setquestionshelp'] = "Postavi ili izmeni pitanje/odgovor za resetovanje lozinke. Nakon toga moći ćete da izmenite svoju lozinku <a href=\"?action=resetbyquestions\">OVDE</a>.";
...
$messages['sendtokenhelpnomail'] = "Unesite svoje korisničko ime da resetujete lozinku. Email će biti poslat na adresu povezanu sa tim korisničkim nalogom. Kada dobijete email, kliknite na link u emailu da bi ste nastavili proceduru.";
$messages['mail'] = "Pošta";
...
$messages['resetbytokenhelp'] = "Link koji je poslat email-om će Vam omogućiti resetovanje lozinke. Da ponovo zatražite email, kliknite <a href=\"?action=sendtoken\">OVDE</a>.";
...
$messages['badcaptcha'] = "reCAPTCHA nije unet kako treba. Molim Vas pokušajte ponovo.";
...
$messages['sendsmshelp'] = "Unesite svoje korisničko ime da dobijete token za resetovanje lozinke. Zatim ukucajte token koji cete dobiti SMS-om.";
$messages['smssent'] = "Potvrdni kod je poslat SMS-om";
...
$messages['smscrypttokensrequired'] = "Ne možete koristiti resetovanje sifre putem SMS-a bez konfigurisanja crypt_tokens u podešavanju";
...
$messages['emptysendsmsform'] = "Preuzmi kod za resetovanje";
$messages['sameaslogin'] = "Vaša nova lozinka je identična Vašem korisničkom imenu";
$messages['policydifflogin'] = "Vaša nova lozinka ne sme biti identična Vašem korisničkom imenu";
