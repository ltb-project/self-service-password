...
$messages['pwned'] = "Your new password was not accepted because it was found in one of the public lists of previously breached passwords, which include passwords recovered from criminals by the FBI. If you are using this password anywhere else, please consider changing it, as it is no longer safe to use.";
