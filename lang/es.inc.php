...
$messages['policydiffminchars'] = "Your new password can not include more than {count} characters that were already present in your previous password";
$messages['diffminchars'] = "Your new and old password are too similar";
