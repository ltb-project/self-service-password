...
$messages['passwordchanged'] = "La tua password é stata cambiata";
...
$messages['sameasold'] = "La nuova password é identica alla vecchia";
...
$messages['questions']['color'] = "Quale é il tuo colore preferito?";
...
$messages['answermoderror'] = "La tua risposta non é stata registrata";
$messages['answerchanged'] = "La tua risposta é stata registrata";
...
$messages['tokensent'] = "Una mail di conferma é stata spedita";
$messages['tokensent_ifexists'] = "Se l'account esiste, una email di conferma é stata inviata all'indirizzo email associato";
...
$messages['changemessage'] = "Buongiorno {login},\n\nLa tua password é stata cambiata.\n\nSe non hai richiesto questa modifica, per favore contatta immediatamente il tuo amministratore di rete.";
$messages['changesubject'] = "La tua password é stata cambiata";
$messages['badcaptcha'] = "Il codice captcha non é corretto. Riprova.";
$messages['captcharequired'] = "Il captcha é richiesto.";
$messages['captcha'] = "Captcha";
$messages['notcomplex'] = "La tua password non é abbastanza complessa";
$messages['policycomplex'] = "Numero minimo di tipi di carattere:";
$messages['smsresetmessage'] = "Il tuo codice per il reset della password é:";
...
$messages['smssent'] = "Un codice di conferma é stato inviato via SMS";
