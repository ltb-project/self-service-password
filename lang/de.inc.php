...
$messages["menumailtoken"] = "Ändern der Email-Adresse";
$messages["resetmailsubject"] = "Ändern Sie Ihre Email-Adresse";
$messages["resetmailmessage"] = "Hallo {login},\n\nKlicken Sie hier um Ihre Email-Adresse zu ändern:\n{url}\n\nFalls Sie keine Änderung beantragt haben, ignorieren Sie dies bitte.";
$messages['sendmailtokenhelp'] = "Geben Sie Ihren Benutzernamen ein um Ihre Email-Adresse zu ändern. Danach klicken Sie auf den Link in der gesendeten Mail.";
$messages['confirmmail'] = "Bestätigen";
$messages['newmail'] = "Neue Email-Adresse";
$messages['newmailrequired'] = "Ihre neue Email-Adresse wird benötigt";
$messages['confirmmailrequired'] = "Bitte bestätigen Sie Ihre neue Email-Adresse";
