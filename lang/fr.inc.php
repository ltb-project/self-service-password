...
$messages['sendtokenhttphelp'] = "Enterez votre identifiant et confirmez votre addresse mail pour réinitialiser votre mot de passe. Cliquez ensuite sur le lien envoyé par notification HTTP.";
...
$messages['httpnotsent'] = "Erreur lors de l'envoi de la HTTP notification";
$messages['httpsent'] = "La notification HTTP a été envoyée";
...
$messages['resetbytokenhttphelp'] = "Le jeton envoyé par notification HTTP vous permet de réinitialiser votre mot de passe. Pour recevoir un nouveau jeton, <a href=\"?action=sendhttp\">cliquez ici</a>.";
...
$messages['emptysendhttpform'] = "Réinitialisez votre mot de passe via un challenge par notification HTTP</a>";
...
$messages['httpnotificationmissingconfiguration'] = "La configuration permettant la réinitialisation de mots de passe par notifications HTTP est incomplète.";
